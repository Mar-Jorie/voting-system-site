          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative" ref={notificationRef}>
              ...
              {showNotificationDropdown && (
                <div className="absolute right-0 mt-2 w-80 max-w-[calc(100vw-2rem)] sm:w-80 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
            ...
            <div className="relative" ref={profileRef}>
              ...
              {showProfileDropdown && (
                <div className="absolute right-0 mt-2 w-48 max-w-[calc(100vw-2rem)] sm:w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
