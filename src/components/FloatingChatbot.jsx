...
const FloatingChatbot = () => {
  ...
  return (
    <>
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-20 right-2 sm:right-4 w-[calc(100vw-1rem)] sm:w-80 md:w-96 lg:w-[28rem] xl:w-96 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden z-80 max-w-[calc(100vw-1rem)] sm:max-w-80 md:max-w-96 lg:max-w-[28rem] xl:max-w-96">
          {/* Header */}
          <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white p-3 sm:p-4 flex items-center justify-center">
          ...
          {/* Messages */}
          <div className="h-64 sm:h-72 md:h-80 overflow-y-auto p-3 sm:p-4 space-y-3 scrollbar-hide">
            {messages.map((msg) => (
              <div key={msg.id} className="space-y-2">
                ...
                <div className={`max-w-[85%] sm:max-w-xs px-3 py-2 rounded-lg text-sm ${
      ...
      <button
        ...
        className="fixed bottom-4 right-2 sm:right-4 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 z-80"
